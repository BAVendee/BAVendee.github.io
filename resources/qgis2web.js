...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-282545.337700, 5824084.721342, -14501.527731, 5959584.809102], maxZoom: 15, minZoom: 1
    })
});
...
map.getView().fit([-282545.337700, 5824084.721342, -14501.527731, 5959584.809102], map.getSize());
