...
var style_parEpiceriesdescommunes_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("nom") !== null) {
        ...
        function rules_parEpiceriesdescommunes_4(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_parEpiceriesdescommunes_4rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_parEpiceriesdescommunes_4rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_parEpiceriesdescommunes_4(feature, value);
        ;
