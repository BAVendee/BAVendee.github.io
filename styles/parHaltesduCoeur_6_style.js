...
var style_parHaltesduCoeur_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("nom") !== null) {
        ...
        function rules_parHaltesduCoeur_6(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_parHaltesduCoeur_6rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_parHaltesduCoeur_6rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_parHaltesduCoeur_6(feature, value);
        ;
