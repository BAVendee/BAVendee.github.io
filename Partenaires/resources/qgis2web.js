...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1004892.780152, 5164087.631559, 1779977.972776, 6641591.407229], maxZoom: 15, minZoom: 1
    })
});
...
map.getView().fit([-1004892.780152, 5164087.631559, 1779977.972776, 6641591.407229], map.getSize());
