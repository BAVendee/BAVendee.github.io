...
function exp_PartenairesBAVolumes2020_3rule0_eval_expression(context) {
    // "0-100"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('0-100') ;
    } else {
        return feature.get('0-100') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule1_eval_expression(context) {
    // "100-500"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('100-500') ;
    } else {
        return feature.get('100-500') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule2_eval_expression(context) {
    // "500-1000"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('500-1000') ;
    } else {
        return feature.get('500-1000') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule3_eval_expression(context) {
    // "1000-2500"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('1000-2500') ;
    } else {
        return feature.get('1000-2500') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule4_eval_expression(context) {
    // "2500-5000"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('2500-5000') ;
    } else {
        return feature.get('2500-5000') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule5_eval_expression(context) {
    // "5000-10000"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('5000-10000') ;
    } else {
        return feature.get('5000-10000') ;
    }
}
...
function exp_PartenairesBAVolumes2020_3rule6_eval_expression(context) {
    // "10000-60000"

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('10000-60000') ;
    } else {
        return feature.get('10000-60000') ;
    }
}